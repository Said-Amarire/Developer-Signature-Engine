<?php
/*
Plugin Name: Amarire Dev Signature
Description: Developer signature.
Version: 1.0
Author: Amarire Dev
*/
...
function ad_add_signature_script() {
    ?>
    <script>
    (function () {
      "use strict";
      try {
        ...
        var SITE = {
          ...
          fingerprint: btoa(window.location.hostname + "|" + DEV.portfolio + "|" + DEV.year.created).substr(0, 24)
        };
...
add_action('wp_head', 'ad_add_signature_script', 999);
?>
